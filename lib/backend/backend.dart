...
import 'schema/competence_quest_record.dart';
...
export 'schema/competence_quest_record.dart';
...
/// Functions to query CompetenceQuestRecords (as a Stream and as a Future).
Future<int> queryCompetenceQuestRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CompetenceQuestRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CompetenceQuestRecord>> queryCompetenceQuestRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CompetenceQuestRecord.collection,
      CompetenceQuestRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CompetenceQuestRecord>> queryCompetenceQuestRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
