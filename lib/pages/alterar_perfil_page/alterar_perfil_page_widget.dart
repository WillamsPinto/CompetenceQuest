...
class AlterarPerfilPageWidget extends StatefulWidget {
  const AlterarPerfilPageWidget({super.key});

  @override
  State<AlterarPerfilPageWidget> createState() =>
      _AlterarPerfilPageWidgetState();
}

class _AlterarPerfilPageWidgetState extends State<AlterarPerfilPageWidget> {
  late AlterarPerfilPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlterarPerfilPageModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserDetailsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserDetailsRecord> alterarPerfilPageUserDetailsRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final alterarPerfilPageUserDetailsRecord =
            alterarPerfilPageUserDetailsRecordList.isNotEmpty
                ? alterarPerfilPageUserDetailsRecordList.first
                : null;
          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: StreamBuilder<List<CompetenceQuestRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<CompetenceQuestRecord>
                            containerCompetenceQuestRecordList = snapshot.data!;
                        // Return an empty Container when the item does not exist.
                        if (snapshot.data!.isEmpty) {
                          return Container();
                        }
                        final containerCompetenceQuestRecord =
                            containerCompetenceQuestRecordList.isNotEmpty
                                ? containerCompetenceQuestRecordList.first
                                : null;
                        return Container(
                          width: 100.0,
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) =>
                                        ...
                                        controller:
                                          ...
                                          _model.sexoValue ??= valueOrDefault(
