...
import '/components/confirma_cadastro/confirma_cadastro_widget.dart';
...
class _CreateAccountPageWidgetState extends State<CreateAccountPageWidget> {
  ...
  void initState() {
    ...
    _model.confirmarpasswordTextController ??= TextEditingController();
    _model.confirmarpasswordFocusNode ??= FocusNode();
  }
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 12.0, 0.0, 24.0),
                            child: Text(
                              'Comecemos por preencher o formulário abaixo.',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    ...
                                    options: const ['Masculino', 'Feminino', 'Outro'],
                                    onChanged: (val) =>
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: TextFormField(
                                      controller: _model
                                          .confirmarpasswordTextController,
                                      focusNode:
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.passwordTextController.text !=
                                      _model.confirmarpasswordTextController
                                          .text) {
