...
import '/components/confirmar_pop_up_sair/confirmar_pop_up_sair_widget.dart';
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed('AlterarPerfilPage');
                                },
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed('FaleConoscoPage');
                                },
                                text: 'Fale Conosco',
                                options: FFButtonOptions(
                                  height: 40.0,
                                        ...
                                        return Dialog(
                                          ...
                                          child: GestureDetector(
                                            onTap: () => _model
                                                ...
                                                : FocusScope.of(context)
                                                    .unfocus(),
                                            child: const ConfirmarPopUpSairWidget(),
                                          ),
                                        );
                                      },
                                    ).then((value) => setState(() {}));
